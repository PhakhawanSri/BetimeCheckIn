...
/**
 * Created by Fatez on 5/13/2016.
 */
public class CheckinAF9WS {
    ...
    public static int invokeCheckinWS(String userName, String latitude, String longitude, String location,String reason, String webMethName) {
        int rpStatus = -1;
        // Create request
        ...
        PropertyInfo reaPI = new PropertyInfo();
        ...
        reaPI.setName("reason");
        reaPI.setValue(reason);
        reaPI.setType(String.class);
        request.addProperty(reaPI);
